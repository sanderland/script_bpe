...
int main() {
    ...
    std::string script_encoding_path = "/Users/sander/Desktop/script_bpe/results/script_encoding.txt";
    std::string merge_rules_path = "/Users/sander/Desktop/script_bpe/results/merge_rules.txt";
    std::string text_path = "/Users/sander/Desktop/script_bpe/results/benchmark_texts.txt";
    ...
    std::cout << "BENCHMARK_RESULT{"
              << "\"seconds\":" << std::fixed << std::setprecision(6) << duration.count() << ","
              << "\"lines\":" << lines.size() << ","
              << "\"tokens\":" << total_tokens << ","
              << "\"tokens_per_sec\":" << total_tokens / duration.count() << ","
