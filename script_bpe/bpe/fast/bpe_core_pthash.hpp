...
namespace script_bpe {
    ...
    private:
        // absl: 14s
        using pthash_type = pthash::single_phf<pthash::murmurhash2_64,                            // base hasher
        ...
        pthash_type mphf_;
    std::vector<std::pair<uint64_t, std::pair<int, int>>> mphf_data_;
            int whitespace_script_id_, inherited_script_id_;
        WorkerState worker_state_;
        // Core processing functions
        inline void try_push_merge(WorkerState& worker_state, int a, int b);
